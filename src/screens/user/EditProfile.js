         ...
         <Container>
            <SafeAreaView style={{ flex: 1,}}>
               <View style={styles.blockHeading}>
                  ...
                  <Text style={styles.blockTitle}>Profile Information</Text>
               </View>
                  ...
                  <View style={styles.profileBody}>
                     <View>
                        ...
                        <View style={styles.editPhotoWrap}>
                           <TouchableOpacity style={styles.editPhoto} onPress={() => navigation.goBack()}>
                              <Entypo name="edit" color="rgba(255, 255, 255, .9)" size={14} />
                           </TouchableOpacity>
                        </View>
                     </View>
